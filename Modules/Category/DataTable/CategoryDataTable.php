...
namespace Modules\Category\DataTable;
...
class CategoryDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        $buttons = array_merge(
            [
//                Button::make('create')->text('<i class="la la-plus mr-05"></i> Add')->addClass('btn btn-sm btn-info box-shadow-05')->action("window.location = '" . route('groups.create') . "';"),
